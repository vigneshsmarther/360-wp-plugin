                    ...
                    <div id="preview-360" class="three-sixty-image-holder"
                        ...
                        <?php for ($i = 1; $i <= 18; $i++) : ?>
                            <img draggable="false" 
                                 ...
                                 style="width: 100%; height: 100%; object-fit: contain; <?php echo $i > 1 ? 'display: none;' : 'display: block;'; ?>">
                        <?php endfor; ?>
                    </div>
                    <div class="loader js-360-loader">
                        <img src="<?php echo plugin_dir_url(dirname(__FILE__)) . 'assets/images/loader.gif'; ?>" alt="loader">
                    </div>
                </div>
            </div>
        </div>
